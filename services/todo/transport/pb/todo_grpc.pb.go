...
type TodoServiceClient interface {
	...
	ListTodo(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListResponse, error)
...
func (c *todoServiceClient) ListTodo(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListResponse, error) {
...
type TodoServiceServer interface {
	...
	ListTodo(context.Context, *Empty) (*ListResponse, error)
...
func (UnimplementedTodoServiceServer) ListTodo(context.Context, *Empty) (*ListResponse, error) {
...
func _TodoService_ListTodo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoServiceServer).ListTodo(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TodoService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "services/todo/transport/pb/todo.proto",
}
